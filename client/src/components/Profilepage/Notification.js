    ...
    return (
        <>
            <div class="list-group notification-group d-none position-absolute">
                ...
                <a href="#" class="list-group-item list-group-item-action">
                    <div class="d-flex w-100 justify-content-between">
                        <h5 class="mb-1 c-black" style={{ color: 'black' }}>Heyy!! Sakshi Requested for Collaboration</h5>
                ...
                <a href="#" class="list-group-item list-group-item-action">
                    <div class="d-flex w-100 justify-content-between">
                        <h5 class="mb-1 c-black" style={{ color: 'black' }}>Heyy!! Dhruv Requested for Collaboration</h5>
                        {/* <small class="text-muted">5 days ago</small> */}
                    </div>
                    <small class="mb-1">I saw your project, and I have some suggestion to imporve it</small>
                    {/* <small class="text-muted">And some muted small print.</small> */}
                ...
                <a href="#" class="list-group-item list-group-item-action">
                    <div class="d-flex w-100 justify-content-between">
                        <h5 class="mb-1 c-black" style={{ color: 'black' }}>Heyy!! Stuti Requested for Collaboration</h5>
                        {/* <small class="text-muted">5 days ago</small> */}
                    </div>
                    <small class="mb-1">I saw your project, and I have some suggestion to imporve it</small>
                    {/* <small class="text-muted">And some muted small print.</small> */}
                ...
                <a href="#" class="list-group-item list-group-item-action">
                    <div class="d-flex w-100 justify-content-between">
                        <h5 class="mb-1 c-black" style={{ color: 'black' }}>Heyy!! Prarthana Requested for Collaboration</h5>
                        {/* <small class="text-muted">5 days ago</small> */}
                    </div>
                    <small class="mb-1">I saw your project, and I have some suggestion to imporve it</small>
                    {/* <small class="text-muted">And some muted small print.</small> */}
